  ...
  return (
    <div className="glass-card p-6 border border-white/5 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="text-slate-400 text-xxs font-bold uppercase mb-1.5 block flex items-center gap-1">
            Initial Capital
            <span className="text-slate-600 font-normal" title="Starting balance at the beginning of the backtest period">
              <HelpCircle size={10} />
            </span>
          </label>
          <div className="relative">
            <span className="absolute left-3.5 inset-y-0 flex items-center text-slate-500 text-xs">$</span>
            <input
              type="number"
              min="100"
              max="10000000"
              ...
              className="w-full bg-slate-950/40 border border-white/10 rounded-xl py-2 pl-7 pr-4 text-xs text-white focus:outline-none focus:border-indigo-500 transition"
            />
          </div>
        </div>
        ...
        <div>
          <label className="text-slate-400 text-xxs font-bold uppercase mb-1.5 block">
            Periodic Plan
          </label>
          <select
            value={getPlanValue()}
            onChange={(e) => handlePlanChange(e.target.value)}
            className="w-full bg-slate-950/60 border border-white/10 rounded-xl py-2 px-3 text-xs text-slate-300 focus:outline-none focus:border-indigo-500 transition"
          >
          ...
          <div className="space-y-4 p-4 bg-slate-900/40 border border-white/5 rounded-2xl animate-fadeIn">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-950 border border-white/10 rounded-xl py-2 pl-7 pr-4 text-xs text-white focus:outline-none focus:border-indigo-500 transition"
                />
                <span className="absolute right-3.5 inset-y-0 flex items-center text-[10px] text-slate-500 uppercase font-bold">
            ...
            <div className="flex items-start gap-2.5 pt-1">
              <input
                ...
                className="mt-0.5 rounded border-white/10 bg-slate-950 text-indigo-600 focus:ring-0 focus:ring-offset-0 focus:outline-none shrink-0"
              />
      ...
      <div className="pt-4 border-t border-white/5 space-y-3">
        <button
          ...
          className="w-full flex items-center justify-between text-xs text-slate-400 hover:text-white transition font-medium"
        >
        ...
        {showInflationTable && (
          <div className="p-3 bg-slate-950/60 border border-white/15 rounded-xl space-y-2 max-h-[180px] overflow-y-auto pr-1 text-xxs scrollbar-thin">
            <div className="flex items-center gap-1.5 text-slate-500 pb-2 border-b border-white/5 mb-2">
              <Info size={11} className="shrink-0" />
              <span>US CPI-U values (1982-1984 average = 100). Higher index reflects price inflation.</span>
            </div>
            
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="font-bold text-slate-500 uppercase border-b border-white/5 pb-1">Year</div>
              <div className="font-bold text-slate-500 uppercase border-b border-white/5 pb-1">CPI Index</div>
              <div className="font-bold text-slate-500 uppercase border-b border-white/5 pb-1">Ann. Infl.</div>
